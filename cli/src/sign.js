...
async function sig (message, signer, publiclyVisibleSignerAddress) {
  ...
  let publiclyVisiblePubKey = await getPubKeyFromAddress(publiclyVisibleSignerAddress)
  ...
  var pub0_array = bigint_to_array(64, 4, publiclyVisiblePubKey.x);
  var pub1_array = bigint_to_array(64, 4, publiclyVisiblePubKey.y);
